...
@Component({
  selector: 'app-shoppingcenter',
  templateUrl: './ShoppingCenter.component.html',
  styleUrls: ['./ShoppingCenter.component.css'],
...
export class ShoppingCenterComponent implements OnInit {
  ...
  constructor(public serviceShoppingCenter: ShoppingCenterService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceShoppingCenter.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.milleradulu.tee.ShoppingCenter',
    ...
    return this.serviceShoppingCenter.addParticipant(this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceShoppingCenter.updateParticipant(form.get('email').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceShoppingCenter.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceShoppingCenter.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
