...
export class ContractComponent implements OnInit {
  ...
  shoppingCenter = new FormControl('', Validators.required);
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.factory) {
        formObject.factory = result.factory;
      } else {
        formObject.factory = null;
      }

      if (result.shoppingCenter) {
        formObject.shoppingCenter = result.shoppingCenter;
      } else {
        formObject.shoppingCenter = null;
      }

      if (result.arrivalTime) {
        formObject.arrivalTime = result.arrivalTime;
      } else {
        formObject.arrivalTime = null;
      }
